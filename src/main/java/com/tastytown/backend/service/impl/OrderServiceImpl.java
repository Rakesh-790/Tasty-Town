...
public class OrderServiceImpl implements IOrderService {
    ...
    public List<OrderDTO> getOrdersByUsers(String userId) {
        var user = userServiceHelper.getUserById(userId);
        return orderRepository.findAllByUser(user, Sort.by(Direction.DESC, "orderDateTime")).stream()
    ...
    private Order createOrderFromCart(Cart cart, BillingInfoDTO billingInfo, User user) {
        ...
        order.setAddressInfo(formatAddresInfo(billingInfo));
    ...
    private String formatAddresInfo(BillingInfoDTO billingInfo) {
